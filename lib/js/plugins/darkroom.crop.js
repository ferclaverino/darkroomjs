...
var Crop = Darkroom.Transformation.extend({
  applyTransformation: function(canvas, image, next) {
    var scaleX = image.getScaleX();
    var scaleY = image.getScaleY();
    ...
    snapshot.onload = function() {
      ...
      imgInstance.setScaleX(scaleX);
      imgInstance.setScaleY(scaleY);
    ...
    // console.log(image.getScaleX(), image.getScaleY());
    // console.log(this.options)
    // console.log(Darkroom.Utils.computeImageViewPort(image))
    // image.setScaleX(1);
    // image.setScaleY(1);
    // console.log(Darkroom.Utils.computeImageViewPort(image))
    ...
    // Medidas ajustadas a la imagen original
    // FUNCIONA!!
    var cropQueFunciona = {
      left: 565,
      top: 301,
    ...
    console.log(crop, cropQueFunciona);
...
Darkroom.plugins['crop'] = Darkroom.Plugin.extend({
  ...
  cropCurrentZone: function() {
    ...
    console.log(cropDimension, imageSize)
